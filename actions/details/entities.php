...
$out.="</table>";
    ...
    $_POST[ids] = '';//need to flush $ids, otherwise $this->show('books_transactions') search for ids IN LIST (...) AND client_id = y
    $_POST[client_id]=$id;
    $_POST[sortby]='date desc';
    $out .=$this->show('books_transactions');
